...
public class NaviDrawer extends Div
	...
	private void initHeader() {
		mainContent.add(new BrandExpression("USAC-CUNOR"));
	}
	...
	private void initFooter() {
		railButton = UIUtilsMod.createSmallButton("Collapse", VaadinIcon.CHEVRON_LEFT_SMALL);
