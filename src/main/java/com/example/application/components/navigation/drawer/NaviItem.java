...
public class NaviItem extends ListItem {
	...
	public NaviItem(String text, Class<? extends Component> navigationTarget) {
		...
		expandCollapse = UIUtilsMod.createButton(VaadinIcon.CARET_UP, ButtonVariant.LUMO_SMALL, ButtonVariant.LUMO_TERTIARY);
	...
	private void updateAriaLabel() {
		...
		UIUtilsMod.setAriaLabel(action, expandCollapse);
	}
