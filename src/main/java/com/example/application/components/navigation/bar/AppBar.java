package com.example.application.components.navigation.bar;
...
import com.example.application.components.navigation.tab.NaviTab;
import com.example.application.components.navigation.tab.NaviTabs;
...
public class AppBar extends Header {
	...
	private void initAvatar() {
		...
		avatar.setSrc(UIUtilsMod.IMG_PATH + "avatar.png");
