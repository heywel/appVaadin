...
import com.example.application.size.Size;
...
public class FlexBoxLayoutMod extends FlexLayout {
	...
	public FlexBoxLayoutMod(Component... components) {
		super(components);
	...
	public void setDisplay(DisplayMod displayMod) {
		getStyle().set(DISPLAY, displayMod.getValue());
	}
	...
	public void setFlexDirection(FlexDirectionMod direction) {
	...
	public void setFlexWrap(FlexWrapMod wrap) {
	...
	public void setOverflow(OverflowMod overflowMod) {
		getStyle().set(OVERFLOW, overflowMod.getValue());
	}
	...
	public void setShadow(ShadowMod shadowMod) {
		getStyle().set(BOX_SHADOW, shadowMod.getValue());
	}
