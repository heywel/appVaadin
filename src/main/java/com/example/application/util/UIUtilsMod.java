...
import com.example.application.util.css.*;
...
public class UIUtilsMod {
	...
	public static FlexLayout createPhoneLayout() {
		...
		FlexBoxLayoutMod layout = new FlexBoxLayoutMod(prefix, number);
	...
	public static void setDisplay(DisplayMod display, Component... components) {
		for (Component component : components) {
	...
	public static void setFlexWrap(FlexWrapMod flexWrap, Component... components) {
		for (Component component : components) {
	...
	public static void setOverflow(OverflowMod overflow, Component... components) {
		for (Component component : components) {
	...
	public static void setPointerEvents(PointerEventsMod pointerEvents, Component... components) {
		for (Component component : components) {
	...
	public static void setShadow(ShadowMod shadow, Component... components) {
		for (Component component : components) {
	...
	public static void setTextAlign(TextAlignMod textAlignMod,
									Component... components) {
		for (Component component : components) {
			component.getElement().getStyle().set("text-align",
					textAlignMod.getValue());
		}
	}
