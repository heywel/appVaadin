...
import com.example.application.views.ViewDetails;
...
import com.example.application.components.navigation.bar.AppBar;
import com.example.application.components.navigation.bar.TabBar;
import com.example.application.components.navigation.drawer.NaviDrawer;
import com.example.application.components.navigation.drawer.NaviItem;
import com.example.application.components.navigation.drawer.NaviMenu;
import com.example.application.util.UIUtilsMod;
import com.example.application.util.css.DisplayMod;
import com.example.application.util.css.OverflowMod;
...
public class MainLayout extends FlexBoxLayoutMod
	...
	private void initNaviItems() {
		...
		menu.addNaviItem(VaadinIcon.CALC_BOOK, "Accounts", Home.class);
		menu.addNaviItem(VaadinIcon.CREDIT_CARD, "Payments", Home.class);
		menu.addNaviItem(VaadinIcon.CHART, "Statistics", Home.class);

		NaviItem personnel = menu.addNaviItem(VaadinIcon.USERS, "Personnel",
				null);
		menu.addNaviItem(personnel, "Details", ViewDetails.class);
		menu.addNaviItem(personnel, "Managers", Home.class);

		NaviItem prueba = menu.addNaviItem(VaadinIcon.CAR, "Prueba", null);
		menu.addNaviItem(prueba, "Sub Preuba", Home.class);
	}
