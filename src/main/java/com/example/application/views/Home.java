...
import com.example.application.util.css.FlexWrapMod;
...
import com.example.application.size.Uniform;
...
public class Home extends ViewFrame {
	...
	private Component createContent() {
		...
		Anchor documentation = new Anchor("https://vaadin.com/docs/business-app/overview.html", UIUtilsMod.createButton("Read the documentation", VaadinIcon.EXTERNAL_LINK));
		Anchor starter = new Anchor("https://vaadin.com/start/latest/business-app", UIUtilsMod.createButton("Start a new project with Business App", VaadinIcon.EXTERNAL_LINK));

		FlexBoxLayoutMod links = new FlexBoxLayoutMod(documentation, starter);
		links.setFlexWrap(FlexWrapMod.WRAP);
		links.setSpacing(Right.S);

		FlexBoxLayoutMod content = new FlexBoxLayoutMod(intro, productivity, features, links);
